...
echo "SUPABASE_SERVICE_KEY   | eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFhbGttaXNoY2h4ZHhsbXFjZWZjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NzYzNzg1MywiZXhwIjoyMDkzMjEzODUzfQ.kMO8iS4o9awK1bWRNn6BWDbobcMHjIZ7IeShOJLEWpo"
echo "JWT_SECRET             | aXNoY2h4ZHhsbXFjZWZjIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI5loijbnmmhv4bn"
echo "SETUP_KEY              | joy-admin-setup-2026"
echo "SETUP_DONE             | true"
echo "CALLMEBOT_PHONE        | +254706158499"
echo "CALLMEBOT_API_KEY      | 3030158"
echo ""
